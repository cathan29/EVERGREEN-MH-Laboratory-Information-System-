...
-- Evergreen LIS minimal schema
CREATE DATABASE IF NOT EXISTS evergreen_lis CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE evergreen_lis;
...
CREATE TABLE IF NOT EXISTS order_items(
  ...
  status VARCHAR(32) DEFAULT 'in_processing',
...
ON DUPLICATE KEY UPDATE name=VALUES(name), department=VALUES(department), price=VALUES(price), tat_hours=VALUES(tat_hours), active=VALUES(active);
